 ...
 * de dependencias. Además EnvioMaterial dependia de la implementacion directa de EmailOutlook, pero se modificó
 * para que dependa de IEmail, permitiendo varías implementanciones de envío por email (con otros servicios) sin
 * tener que modificar EnvioMaterial, además de invertir la dependencia.
 * 
 * Aunque antes no habían interfaces, con las interfaces ICarrera e IEmail, se puede cumplir el principio de
 * segregación de interfaces, debido a que las clases de las implementan puedan tener su logica especifica y no
 * tener metodos innecesarios.
 *
